// Assignments:
// 1. Using either the Color Schemer Online or ColorPicker.com, make a color of your own and change the
//    middle circle (the yellow one) to your custom color.
// 2. Draw a second, slightly smaller pacman to the right of the first pacman. Make her face to the left
//    and make her pink.
...
public class GraphicsDemo2 extends Canvas
{
    public void paint( Graphics g )
    {
        ...
        g.fillArc(300,425,100,100,225,270); // chomp

        // custom colors
        Color myOrange = new Color(230,92,0); // the amount of red, green, blue in the color
        Color myTurquoise = new Color(56, 229, 244); // my own color
